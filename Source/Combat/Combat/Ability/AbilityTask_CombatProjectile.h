...
UCLASS()
class COMBAT_API UAbilityTask_SpawnLinearProjectile : public UAbilityTask
{
	GENERATED_BODY()
...
UCLASS()
class COMBAT_API UAbilityTask_SpawnTrackingProjectile : public UAbilityTask
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class COMBAT_API UAbilityTask_WaitProjectileResult : public UAbilityTask
{
	GENERATED_BODY()
