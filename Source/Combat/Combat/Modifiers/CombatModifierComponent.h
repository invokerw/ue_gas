...
struct COMBAT_API FCombatModifierApplyRequest
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatModifierApplyResult
{
	GENERATED_BODY()
...
class COMBAT_API UCombatModifierComponent : public UActorComponent
{
	GENERATED_BODY()
