...
struct COMBAT_API FCombatAssetValidationIssue
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatAssetValidationReport
{
	GENERATED_BODY()
...
class COMBAT_API UCombatAssetValidationSettings : public UObject
{
	GENERATED_BODY()
...
struct COMBAT_API FCombatAssetValidator
{
...
UCLASS()
class COMBAT_API UCombatAssetValidationCommandlet : public UCommandlet
{
	GENERATED_BODY()
