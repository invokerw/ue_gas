...
class COMBAT_API UCombatMagicShieldRuntime : public UCombatModifierRuntime
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class COMBAT_API UCombatPeriodicDamageRuntime : public UCombatModifierRuntime
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class COMBAT_API UCombatDamageReflectionRuntime : public UCombatModifierRuntime
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class COMBAT_API UCombatDemoOrbRuntime : public UCombatModifierRuntime
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class COMBAT_API UCombatFrostArrowsRuntime : public UCombatModifierRuntime
{
	GENERATED_BODY()
...
UCLASS(Blueprintable)
class COMBAT_API UCombatSpellBlockRuntime : public UCombatModifierRuntime
{
	GENERATED_BODY()
...
UCLASS()
class COMBAT_API UCombatHookDragRuntime : public UCombatModifierRuntime
{
	GENERATED_BODY()
