...
/** 无目标自我治疗示例 Ability。 */
UCLASS()
class COMBAT_API UCombatSelfHealAbility : public UCombatGameplayAbility
{
	GENERATED_BODY()
};
...
UCLASS()
class COMBAT_API UCombatUnitDamageAbility : public UCombatGameplayAbility
{
	GENERATED_BODY()
};
...
UCLASS()
class COMBAT_API UCombatPointAoeAbility : public UCombatGameplayAbility
{
	GENERATED_BODY()
};
...
UCLASS()
class COMBAT_API UCombatDragonSlaveAbility : public UCombatGameplayAbility
{
	GENERATED_BODY()
};
...
UCLASS()
class COMBAT_API UCombatMeatHookAbility : public UCombatGameplayAbility
{
	GENERATED_BODY()
};
...
UCLASS()
class COMBAT_API UCombatFrostArrowsAbility : public UCombatGameplayAbility
{
	GENERATED_BODY()
};
...
UCLASS()
class COMBAT_API UCombatFissureAbility : public UCombatGameplayAbility
{
	GENERATED_BODY()
...
UCLASS()
class COMBAT_API UCombatChannelProbeAbility : public UCombatGameplayAbility
{
	GENERATED_BODY()
