...
struct COMBAT_API FCombatProjectileHitPolicy
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct COMBAT_API FCombatProjectileImpactAction
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct COMBAT_API FCombatProjectileSpec
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatProjectileResult
{
	GENERATED_BODY()
