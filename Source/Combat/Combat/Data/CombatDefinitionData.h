...
struct COMBAT_API FCombatModifierAttributeChange
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct COMBAT_API FCombatDefinitionRedirect
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct COMBAT_API FCombatSpecialValue
{
	GENERATED_BODY()
...
class COMBAT_API UCombatDefinitionData : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
class COMBAT_API UCombatUnitData : public UCombatDefinitionData
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType)
class COMBAT_API UCombatAbilityData : public UCombatDefinitionData
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType)
class COMBAT_API UCombatModifierData : public UCombatDefinitionData
{
	GENERATED_BODY()
 ...
 */
UCLASS(BlueprintType)
class COMBAT_API UCombatProjectileData : public UCombatDefinitionData
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatAbilitySetEntry
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class COMBAT_API UCombatAbilitySet : public UCombatDefinitionData
{
	GENERATED_BODY()
