...
struct COMBAT_API FCombatDamageRequest
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatDamageEvent
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatDamageResult
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatHealRequest
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatHealEvent
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatHealResult
{
	GENERATED_BODY()
...
struct COMBAT_API FCombatTransactionDelta
{
	/** 变化前的 Health。 */
