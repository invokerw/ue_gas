...
struct COMBAT_API FCombatControlPresentationRule
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatOverheadDisplayData
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatOverheadProgressData
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatFloatingTextPayload
{
	GENERATED_BODY()
