...
struct COMBAT_API FCombatModifierView : public FFastArraySerializerItem
{
	GENERATED_BODY()
...
/** FastArray 增量复制容器。 */
USTRUCT()
struct COMBAT_API FCombatModifierViewArray : public FFastArraySerializer
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatUnitView
{
	GENERATED_BODY()
