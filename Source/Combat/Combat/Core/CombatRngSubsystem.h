...
struct COMBAT_API FCombatRngPolicyV1
{
...
struct COMBAT_API FCombatRngSubjectId
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatRngRollRecord
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class COMBAT_API UCombatRngSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
