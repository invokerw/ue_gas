...
struct COMBAT_API FCombatTeamId
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatEventId
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct COMBAT_API FCombatHandleKey
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatModifierHandle
{
	GENERATED_BODY()
	/** Modifier 的共享身份键。 */
...
/** 标识一次绑定单位生命代次的攻击记录。 */
USTRUCT(BlueprintType)
struct COMBAT_API FCombatAttackHandle
{
	GENERATED_BODY()
	/** 攻击记录的共享身份键。 */
	UPROPERTY(BlueprintReadOnly, Category="Combat|Handle") FCombatHandleKey Key;
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatOrderHandle
{
	GENERATED_BODY()
	/** Order 的共享身份键。 */
	UPROPERTY(BlueprintReadOnly, Category="Combat|Handle") FCombatHandleKey Key;
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatProjectileHandle
{
	GENERATED_BODY()
	/** 弹体的共享身份键。 */
	UPROPERTY(BlueprintReadOnly, Category="Combat|Handle") FCombatHandleKey Key;
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatThinkerHandle
{
	GENERATED_BODY()
	/** Thinker 的共享身份键。 */
	UPROPERTY(BlueprintReadOnly, Category="Combat|Handle") FCombatHandleKey Key;
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatMotionHandle
{
	GENERATED_BODY()
	/** Motion 的共享身份键。 */
	UPROPERTY(BlueprintReadOnly, Category="Combat|Handle") FCombatHandleKey Key;
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatAuraHandle
{
	GENERATED_BODY()
	/** Aura 的共享身份键。 */
	UPROPERTY(BlueprintReadOnly, Category="Combat|Handle") FCombatHandleKey Key;
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatScheduleHandle
{
	GENERATED_BODY()
	/** 调度槽位的共享身份键。 */
	UPROPERTY(BlueprintReadOnly, Category="Combat|Handle") FCombatHandleKey Key;
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatOperationResult
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct COMBAT_API FCombatScheduledTickContext
{
	GENERATED_BODY()
