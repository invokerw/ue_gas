...
namespace CombatTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_OrderStateChanged, "Event.Combat.OrderStateChanged")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_AttackLaunched, "Event.Combat.AttackLaunched")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_AttackLanded, "Event.Combat.AttackLanded")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_AttackFailed, "Event.Combat.AttackFailed")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_ProjectileSpawned, "Event.Combat.ProjectileSpawned")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_ProjectileHit, "Event.Combat.ProjectileHit")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_ProjectileFinished, "Event.Combat.ProjectileFinished")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_ThinkerPulse, "Event.Combat.ThinkerPulse")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_ThinkerFinished, "Event.Combat.ThinkerFinished")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_MotionStarted, "Event.Combat.MotionStarted")
	UE_DEFINE_GAMEPLAY_TAG(Event_Combat_MotionFinished, "Event.Combat.MotionFinished")
	...
	UE_DEFINE_GAMEPLAY_TAG(Order_Failure_TargetInvalid, "Order.Failure.TargetInvalid")
	UE_DEFINE_GAMEPLAY_TAG(Order_Failure_OutOfRange, "Order.Failure.OutOfRange")
	UE_DEFINE_GAMEPLAY_TAG(Order_Failure_InvalidRequest, "Order.Failure.InvalidRequest")
	UE_DEFINE_GAMEPLAY_TAG(Order_Failure_StaleCallback, "Order.Failure.StaleCallback")
	UE_DEFINE_GAMEPLAY_TAG(Order_Failure_RetryExhausted, "Order.Failure.RetryExhausted")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Attack_NotReady, "Combat.Failure.Attack.NotReady")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Attack_Blocked, "Combat.Failure.Attack.Blocked")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Attack_StaleHandle, "Combat.Failure.Attack.StaleHandle")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Attack_Evaded, "Combat.Failure.Attack.Evaded")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Projectile_StaleHandle, "Combat.Failure.Projectile.StaleHandle")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Projectile_Blocked, "Combat.Failure.Projectile.Blocked")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Projectile_TargetLost, "Combat.Failure.Projectile.TargetLost")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Projectile_Timeout, "Combat.Failure.Projectile.Timeout")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Thinker_StaleHandle, "Combat.Failure.Thinker.StaleHandle")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Motion_ChannelBusy, "Combat.Failure.Motion.ChannelBusy")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Motion_Blocked, "Combat.Failure.Motion.Blocked")
	UE_DEFINE_GAMEPLAY_TAG(Failure_Motion_StaleHandle, "Combat.Failure.Motion.StaleHandle")
