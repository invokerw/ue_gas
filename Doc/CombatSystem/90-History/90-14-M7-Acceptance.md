...
| MCP-701 | [30-02 M7 UE MCP 联机诊断配方](../30-Tooling/30-02-M7-MCP-Diagnostic-Recipe.md) 固化 World 身份、复制矩阵、安全 RPC、事件、Projectile、性能与资产诊断顺序，并提供 MCP 不可用时的命令行等价入口 |
...
完整网络与容量边界见 [90-13 M7 联机、可观测性与容量决策](90-13-M7-Network-Observability-Decision.md)。ADR-038/039/040 已关闭 GAP-021/019/018。
