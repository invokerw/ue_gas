# 90-09 M5 Projectile、Thinker 与 Motion 决策

## 1. 冻结范围

本文件冻结 M5 的 Projectile registry、连续 sweep、Tracking 目标丢失、Thinker 调度和 Motion 抢占协议。它补充 [10-04 Modifier、属性与 Motion](../10-Architecture/10-04-Modifier-Attributes-Motion.md)、[10-06 普攻、法球、Projectile 与 Thinker](../10-Architecture/10-06-Attack-Projectile-Thinker.md) 与 [20-01 示例技能](../20-Content/20-01-Example-Skills.md)。
