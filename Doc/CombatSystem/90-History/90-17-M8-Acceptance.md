...
| REL-002 | [90-16 生命周期审计](90-16-M8-Lifecycle-Audit.md)登记 Handle、Delegate、Schedule、Runtime、Actor 的 owner、退出与旧回调防护；真实 World 测试验证全部清零和 exactly-once |
...
| REL-005 | 发布契约、生命周期清单、[公共扩展与迁移指南](../20-Content/20-03-M8-Public-Extension-Guide.md)、事件序列和 DataAsset/蓝图扩展面自动化完成 |

完整发布边界见 [90-15 M8 候选发布决策](90-15-M8-Release-Candidate-Decision.md)。GAP-015/017/022 均已显式延期并进入机器可读发布契约，不再存在未知 v1 功能边界。
