...
- 物理护甲使用 [10-05](../10-Architecture/10-05-Damage-Heal.md) 的公式；FormulaVersion v1 固定为 `1`。
...
| --- | --- | --- | --- | --- |
| GAP-001 | 按 DEC-001 关闭 | TeamSubsystem / Targeting | [10-03](../10-Architecture/10-03-Ability-Targeting-Blueprint.md)、[10-07](../10-Architecture/10-07-Order-Movement.md) | M1 pure + M3 targeting |
| GAP-002 | 按 DEC-002 关闭 | UnitLifecycleComponent | [10-04](../10-Architecture/10-04-Modifier-Attributes-Motion.md)、[10-05](../10-Architecture/10-05-Damage-Heal.md) | M2 lifecycle |
| GAP-003 | 按 DEC-003 关闭 | Ability/AbilitySet | [10-03](../10-Architecture/10-03-Ability-Targeting-Blueprint.md) | M1 asset + M3 ability |
| GAP-004 | 按 DEC-006 关闭 | Tags/Data/Asset validation | [10-08](../10-Architecture/10-08-Data-Network-Observability.md) | M1 tags/assets |
| GAP-006 | 按 DEC-004 关闭 | CombatRngSubsystem | [10-05](../10-Architecture/10-05-Damage-Heal.md)、[10-06](../10-Architecture/10-06-Attack-Projectile-Thinker.md) | M1 pure + M4 attack |
| GAP-007 | 按 DEC-004 关闭 | NumericPolicy/Calculator | [10-04](../10-Architecture/10-04-Modifier-Attributes-Motion.md)、[10-05](../10-Architecture/10-05-Damage-Heal.md) | M1 pure + M2 calculator |
| GAP-009 | 按 DEC-005 关闭 | Targeting/Projectile/Config | [10-06](../10-Architecture/10-06-Attack-Projectile-Thinker.md)、[10-07](../10-Architecture/10-07-Order-Movement.md) | M3 LOS + M5 projectile |
| GAP-020 | 接受 M1 到期方案，M0 不提前实现 | TST-003 | [00-02](../00-Project/00-02-Implementation-Roadmap.md)、[00-03](../00-Project/00-03-Test-Plan.md) | M1 UBT/build/connect smoke |
