# 90-07 M4 Order 与普攻决策

## 1. 冻结范围

本文件冻结 M4 的 Order generation、移动回调、普攻时序和法球提交协议。它补充 [10-06 普攻、法球、Projectile 与 Thinker](../10-Architecture/10-06-Attack-Projectile-Thinker.md) 与 [10-07 Order 与 NavMesh 移动](../10-Architecture/10-07-Order-Movement.md)，不提前实现 M5 的远程弹体。
