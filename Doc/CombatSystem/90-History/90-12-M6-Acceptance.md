...
| 技能模板 Gate | `FCombatSkillTemplateValidator` 校验 Class/Data 身份、schema、必需 behavior/special、Definition 唯一与事件顺序；提供稳定旁路模式和 [20-02 检查表](../20-Content/20-02-M6-Skill-Template-Checklist.md) |

实现语义见 [90-11 M6 复杂技能集决策](90-11-M6-Content-Decision.md)。ADR-036/037 已关闭 GAP-014/GAP-016。
